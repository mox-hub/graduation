<template>
    ...
    <div>
        <a-form v-if="flag == 'login'" direction="vertical" class="login-container" :model="form"
            ...
            <a-form-item>
                <a-button class="button" type="primary" size="large" shape="round" long>登录</a-button>
                <a-button class="button" shape="round" size="large" @click="changeFlag('register')" long>注册</a-button>
            </a-form-item>
        </a-form>
        <a-form v-if="flag == 'register'" direction="vertical" class="login-container" :model="regForm"
            :style="{ width: '500px' }">
